...
\resumeSubheading
    ...
    \resumeItemListStart
      \item Working on state-of-the-art dynamic SLAM under the supervision of Dr. Dániel Béla Baráth, integrating semantic scene graphs into deep visual SLAM by extending DROID-SLAM in the Wild (DROID-W) to improve efficiency and robustness in unconstrained environments
    \resumeItemListEnd
...
\resumeSubheading
    ...
    \resumeItemListStart
      \item Supporting the development of \href{https://wildinsync.org/}{WildInSync}, an initiative for global biodiversity monitoring that combines environmental DNA, remote sensing, and AI to generate standardized data for conservation research and decision-making
    \resumeItemListEnd
\resumeSubheading
...
\resumeSubheading
    {VU Amsterdam - Sports Intelligence Lab (SIL) [\href{https://sportsintelligencelab.com/}{\faIcon{globe}}]}{Remote}
    {Research Assistant}{Jun 2025 – Mar 2026}
    \resumeItemListStart
      \item Conducted data-driven research on ball recovery in professional football and explored machine learning applications in the sport under the supervision of Dr. Mauricio Verano Merino
      \item Analyzed large-scale educational data to evaluate the effects of Generative AI tools on student outcomes in programming courses, contributing to a paper published at \emph{ICSE 2026 (SEET Track)}
    \resumeItemListEnd
...
\resumeSubHeadingListStart
\resumeSubheading
    {ETH Robotics Club (ETHRC) - Aeronautics [\href{https://www.ethrobotics.ch/}{\faIcon{globe}}]}{Zürich, Switzerland}
    {Robotic Perception Engineer}{Apr 2025 – Present}
    \resumeItemListStart
      \item Working with the Aeronautics team, where we use autonomous FPV racing drones to push the limits of high-speed aerial robotics, contributing to the perception stack by developing real-time visual-inertial odometry (VIO), gate detection, state estimation, Kalman filtering, sensor fusion, and motion capture to support environment perception, localization, and autonomous navigation in dynamic environments
    \resumeItemListEnd
...
\publicationEntry
  {\href{https://doi.org/10.1145/3786580.3786955}{The Clash of Codes: From Peer-to-Peer Duplication to
AI-Generation in Introductory Programming Assignments}}
  ...
  {ICSE 2026 (SEET Track)}
  {}{}
\vspace{-0.38cm}
\publicationEntry
  {\href{https://pnnayyeri.github.io/contents/labview_book_en.pdf}{Programming Lego MINDSTORMS Robots
using NI LabVIEW®}}
  {Pooyan Nayyeri, \textbf{Mahbod Tajdini}}
{Open-access eBook - April 2022}
{}{}
\end{publist}
\vspace{-5mm}
...
\vspace{-2.5mm}
\resumeSubHeadingListStart
  \resumePOR{}{\emph{3rd place} at \href{https://www.datathon.ai/}{Datathon by Analytics Club at ETH} – Switzerland's largest ML hackathon}{Apr 2026}
  \resumePOR{}{\emph{4th place} at \href{https://claudethzurich.com/events/anthropic-hackathon}{Anthropic Hackathon by Claude Builder Club of ETH Zürich}}{Mar 2026}
\resumeSubHeadingListEnd
...
\resumeSubItem{Programming Languages}{: Python, C++, CUDA, R, SQL, Prolog}
\resumeSubItem{Machine Learning \& Deep Learning}{: PyTorch, PyTorch Geometric (PyG), TensorFlow, Scikit-Learn, HuggingFace, timm}
\resumeSubItem{Computer Vision \& 3D}{: OpenCV, Open3D, Kornia, scikit-image, lietorch, Gaussian Splatting, Ultralytics (YOLO), Stardist, OpenSlide, Roboflow}
\resumeSubItem{Robotics}{: ROS 2, Gazebo, OpenVINS, PX4, Kalibr}
\resumeSubItem{MLOps \& Experimentation}{: Hydra, Weights \& Biases, TensorBoard, Docker}
\resumeSubItem{Data Science \& Scientific Computing}{: NumPy, Pandas, SciPy, Statsmodels, Jupyter}
\resumeSubItem{Developer Tools}{: Git, MySQL, \LaTeX}
